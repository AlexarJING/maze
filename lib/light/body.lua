...
local function new(id, type, ...)
  ...
  obj.is_on_screen = true
    ...
    obj.img_data = circle_canvas:newImageData()
    obj.img = love.graphics.newImage(obj.img_data) 
...
function body:setPoints(...)
  ...
  if not self.img then
    self.img_data = poly_canvas:newImageData()
...
function body:generateNormalMapFlat(mode)
  self:setNormalMap(normal_map.generateFlat(self.img,self.img_data, mode))
end
